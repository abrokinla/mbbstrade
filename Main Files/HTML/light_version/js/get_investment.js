$(document).ready(function() {
    ...
    console.log(fetchInvestmentDataURL);
    ...
    function investmentDays(){
      ...
      if (!investmentData) {
        ...
        if (todayDate > end_date) {
          ...
          const daysRemaining = Math.round((start_date.getTime() - today_date.getTime()) / millisecondsPerDay);
    ...
    function calculateInterest() {
      ...
      const amount = parseFloat(investmentData[0].amount.replace("$", ""));
